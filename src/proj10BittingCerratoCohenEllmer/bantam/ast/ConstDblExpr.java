 ...
 * @see ConstExpr
 */
public class ConstDblExpr extends ConstExpr {
    /**
     * The constant value represented as an int
     */
    private double dblConst;
     ...
     */
    public ConstDblExpr(int lineNum, String constant) {
        super(lineNum, constant);
        dblConst = Double.parseDouble(constant);
    }
