...
package proj10BittingCerratoCohenEllmer.bantam.ast;
 ...
 * @see ConstExpr
 */
public class ConstChrExpr extends ConstExpr {
    /**
     * The constant value represented as an int
     */
    private char chrConstant;
     ...
     */
    public ConstChrExpr(int lineNum, String constant) {
        super(lineNum, constant);
        chrConstant = constant.charAt(0);
    }

    /**
     * Get the constant value represented as an char
     *
     * @return the constant value
     */
    public int getChrConstant() {
        return chrConstant;
    }
