...
package proj9BittingCerratoCohenEllmer.bantam.treedrawer;

import proj9BittingCerratoCohenEllmer.bantam.ast.Program;
...
public class Drawer {
    ...
    public void draw(String sourceName, Program AST) {
        ...
        proj9BittingCerratoCohenEllmer.bantam.treedrawer.LayoutVisitor layout = new LayoutVisitor(fontMetrics);
        proj9BittingCerratoCohenEllmer.bantam.treedrawer.DrawingTree theDrawing = (DrawingTree) AST.accept(layout);
