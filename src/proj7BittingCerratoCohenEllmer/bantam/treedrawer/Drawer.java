...
package proj7BittingCerratoCohenEllmer.bantam.treedrawer;
...
public class Drawer {
    ...
    public void draw(String sourceName, Program AST) {
        ...
        proj7BittingCerratoCohenEllmer.bantam.treedrawer.LayoutVisitor layout = new LayoutVisitor(fontMetrics);
        proj7BittingCerratoCohenEllmer.bantam.treedrawer.DrawingTree theDrawing = (DrawingTree) AST.accept(layout);
